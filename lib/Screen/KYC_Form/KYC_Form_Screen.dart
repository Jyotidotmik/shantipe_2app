...
import 'package:shantipe_2app/ApiService/Api_Service.dart';
...
import 'package:shantipe_2app/Utils/App_Color.dart';
import 'package:shantipe_2app/Utils/Custom_AppBar.dart';
import 'package:shantipe_2app/Utils/Custom_button.dart';
                        ...
                        onPressed:
                            _isLoading
                                ...
                                : () async {
                                  ...
                                  try {
                                    bool isVerified = await apiService
                                        .kycOtpverify(otpCode);
                                    if (isVerified) {
                                      setState(() {
                                        _isLoading = false;
                                      });
  ...
  void _submitForm() async {
    ...
    if (response['status'] == 'SUCCESS') {
      Navigator.pushReplacement(
        context,
        MaterialPageRoute(builder: (context) => KycPendingScreen()),
      );
    } else {
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(
    ...
    return Scaffold(
      ...
      bottomNavigationBar: Container(
        ...
        child: Row(
          ...
          children: [
            if (_currentStep > 2)
              CustomButton(text: 'Previous', onPressed: _previousStep),
            CustomButton(
