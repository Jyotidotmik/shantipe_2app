          ...
          children: [
            ...
            if (isNextButton) // Image to the right of next button
              Padding(
                ...
                child: Image.asset(
                  "lib/assets/images/chevron-right.png",
                  width: 24,
                  height: 24,
                ),
              ),
...
class CustomNormalButton extends StatelessWidget {
  ...
  const CustomNormalButton({Key? key, required this.buttonText, required this.onTap}) : super(key: key);
...
class CustomImageButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialButton(
      onPressed: onPressed,
      child: Container(
        constraints: BoxConstraints(minWidth: 160, maxWidth: screenWidth * 0.9),
